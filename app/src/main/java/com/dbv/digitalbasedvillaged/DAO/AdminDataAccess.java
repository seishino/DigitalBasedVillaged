...
public class AdminDataAccess {
    ...
    public void fetchAllDataVillager(final OnGetDataListener listener)
    {
        FirebaseDatabase db = FirebaseDatabase.getInstance();
        DatabaseReference myRef = db.getReference();

        myRef.child("Villager").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                listener.onComplete(dataSnapshot);
            }
    ...
    public void fetchFamilyMember(final OnGetDataListener listener, String noKK)
    {
        FirebaseDatabase db = FirebaseDatabase.getInstance();
        DatabaseReference myRef = db.getReference();

        myRef.child("Villager").child(noKK).child("Member").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                listener.onComplete(dataSnapshot);
            }
    ...
    public void fetchAllDataForVerification(final OnGetDataListener listener)
    {
        FirebaseDatabase db = FirebaseDatabase.getInstance();
        DatabaseReference myRef = db.getReference();
    ...
    public void fetchDataVillagerByNoKK(final OnGetDataListener listener, String noKK)
    {
        FirebaseDatabase db = FirebaseDatabase.getInstance();
        DatabaseReference myRef = db.getReference();
        myRef.child("Villager").child(noKK).addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                listener.onComplete(dataSnapshot);
            }
    ...
    public void addData(Family family)
    {
        ...
        for(Villager v : family.getFamilyList())
        {
            ...
            data.put("Gender",v.getGender());
            data.put("Role",v.getRole());
            data.put("DateOfBirth",v.getDateOfBirth());
            data.put("PlaceOfBirth",v.getPlaceOfBirth());
            data.put("Job",v.getJob());
        }
    ...
    public void verificationFamily(String noKK)
    {
        FirebaseDatabase db = FirebaseDatabase.getInstance();
        DatabaseReference myRef = db.getReference();
        myRef.child("Users").child(noKK).child("Status").setValue("Verification");
    }
    public void noVerificationFamily(String noKK)
    {
        FirebaseDatabase db = FirebaseDatabase.getInstance();
        DatabaseReference myRef = db.getReference();
        myRef.child("Users").child(noKK).child("Status").setValue("NoVerification");
    }
    public void deleteFamily(String noKK)
    {
        FirebaseDatabase db = FirebaseDatabase.getInstance();
        DatabaseReference myRef = db.getReference();
        myRef.child("Users").child(noKK).removeValue();
        myRef.child("Villager").child(noKK).removeValue();
    }
    ...
    public void resetPassword(String noKKrequest)
    {
        FirebaseDatabase db = FirebaseDatabase.getInstance();
        DatabaseReference myRef = db.getReference();
        myRef.child("Users").child(noKKrequest).child("Password").setValue(noKKrequest);
    }
    public void givePrivillege(String noKKRequest)
    {
        FirebaseDatabase db = FirebaseDatabase.getInstance();
        DatabaseReference myRef = db.getReference();
        myRef.child("Users").child(noKKRequest).child("Role").setValue("Admin");
    }
    public void removePrivillege(String noKKRequest)
    {
        FirebaseDatabase db = FirebaseDatabase.getInstance();
        DatabaseReference myRef = db.getReference();
        myRef.child("Users").child(noKKRequest).child("Role").setValue("Villager");
    }
}
