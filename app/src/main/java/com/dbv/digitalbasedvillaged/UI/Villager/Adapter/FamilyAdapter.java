package com.dbv.digitalbasedvillaged.UI.Villager.Adapter;
...
public class FamilyAdapter  extends RecyclerView.Adapter<FamilyAdapter.MyViewHolder> {
    ...
    public FamilyAdapter(List<Villager> myDataset, DefaultLayout root) {
        mDataset = myDataset;
        this.root = root;
    }
            ...
            public void onClick(View v) {
                ...
                popupMenu.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
                    ...
                    public boolean onMenuItemClick(MenuItem item) {
                        ...
                        {
                            villagerController.removeMember(mDataset.get(position).getNik());
                        }
            ...
            public void onClick(View v) {
                villagerController.checkVillager(new OnGetDataListenerFamily() {
                    ...
                    public void onComplete(Family family) {
                        ...
                        villagerController.updateData(villager);
                        pw.dismiss();
